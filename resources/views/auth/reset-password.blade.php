...
<head>
    ...
    <title>Reset Password · Nsential</title>
        ...
        <div class="rise d2 w-full max-w-md">
            <div class="text-center mb-6">
                <h1 class="text-3xl font-bold tracking-tight mb-2">
                    Choose a new <span class="grad-text">password.</span>
                </h1>
                <p class="text-gray-400 text-sm">Make it something you haven't used here before.</p>
            </div>
